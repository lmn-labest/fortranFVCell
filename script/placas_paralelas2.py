...
#**********************************************************************
def profilVel(vel1,vel2,y):
  v0   = 0.5* ( vel1 + vel2 + (vel1 - vel2)*m.tanh(2.0*y)) 
#  print v0,y,vel2,vel1
  return v0
#**********************************************************************
...
# ...
  ...
  for i in range(0,nh-1):
    ym  = 0.5*(y1+y2)
    vel = profilVel(vel1,vel2,ym-0.5*h)
#   vel = profilVel(vel1,vel2,ym)
    y1  = y1+ float(dh)
    y2  = y2+ float(dh)
    f.write("%9d " 
          "%.2f %.2f %.2f "
